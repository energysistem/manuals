...
Pour éliminer le Widget maintenez-le pendant quelques secondes sans le lâcher, un icone de apparaîtra dans l'écran, glisser jusqu'à l'icone X et puis lâcher.

Pour ajouter, déplacer ou éliminer des applications vous devez seulement choisir l'application depuis le menu "applications et widgets" (1) et suivre les mêmes démarches.
