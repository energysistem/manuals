...
4) Mantén pulsado el botón SINCRONIZACIÓN WIFI () de tu altavoz hasta escuchar "Esperando conexión Wifi". Si la sincronización no se ha realizado correctamente, vuelve a realizar el proceso desde el punto 1). 
