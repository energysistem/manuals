...
Quand vous allumez l'appareil, s'initiera automatiquement en mode entrée de ligne. Branchez le câble audio (inclut) à la sortie de tout lecteur et à l'entrée LINE-IN (13) de l'*Energy Music Box Z3* pour utiliser le mode de l'haut-parleur. Pour changer entre les différents modes de lecture, appuyez sur MODE (3).
