...
* Não exponha seu *Energy Music Box Z1* a choques, a poeira, humidade, ou as altas temperaturas.
* Não use produtos de limpeza corrosivos ou abrasivos.
* Não posicione seu *Energy Music Box Z1* perto de dispositivos que emitem campos electromagnéticos intensos.
...
* Assegure-se de manter seu *Energy Music Box Z1* desligado quando não esteja em uso.
