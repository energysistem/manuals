...
Al encender tu *Energy Music Box BZ1*, automáticamente reproducirá desde la fuente que esté conectada en ese momento (tarjeta o line-in); en caso de tener ambas conexiones activas prioriza la reproducción desde la tarjeta micro SD. 
