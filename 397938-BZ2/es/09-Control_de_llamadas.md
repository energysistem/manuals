...
Para contestar una llamada únicamente tienes que pulsar el botón de CONTROL DE LLAMADA (6). En caso de estar escuchando alguna canción por el altavoz en el instante de recibir la llamada, ésta se detendrá en ese momento escuchándose el tono de llamada. Para finalizar la llamada pulsa nuevamente el botón de CONTROL DE LLAMADA (6), la canción se reanudará desde el mismo momento en el que se recibió la llamada.
