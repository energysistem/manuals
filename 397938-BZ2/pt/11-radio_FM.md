...
Para a realização desta sintonização de canais de radio, mantenha premido o botão de NAVEGAÇÃO POR PASTAS (4) durante 2 segundos. Esto armazenará todas as emissoras encontradas na memória interna do dispositivo.  Esta operação pode demorar alguns minutos.
