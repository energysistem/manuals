...
Pour allumer l'appareil, déplacez le bouton ON/OFF (10) vers la position ON et vous verrez que le LED (5) clignote en vert. L'haut-parleur émettra un son de bienvenue qu'indique que l'appareil est allumé.

Pour éteindre l'appareil, déplacez le bouton ON/OFF (10) vers la position OFF.

Si l'appareil est allumé, la lumière LED indicateur (5) sera allumée en vert.
### Changement du mode de lecture

Après avoir allumé l'appareil, la recherche d'appareils bluetooth démarrera automatiquement. Pour changer vers le mode line-in, il faut brancher le câble audio (inclut) à la connexion line-in (9). Pour changer entre les différents modes de lecture, appuyez le touche menu (5). En mode line-in, l'indicateur LED (5) changera à couleur vert. </quick_guide>
