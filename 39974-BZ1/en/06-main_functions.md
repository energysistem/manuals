...
When you turn on the device, pairing mode will start automtically. To change into "line in" mode, you only need to connect the audio cable (included) to the "line in" connection (9). To switch between different playback modes press the menu button (5). 
