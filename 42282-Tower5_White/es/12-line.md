...
Para usar la reproducción "line-in", conecta un extremo del cable de audio suministrado en la entrada de línea (10), y en el otro extremo la salida del dispositivo de audio, como un reproductor MP3, un ordenador portátil, un smartphone, etc. En el momento que se conecte el cable a la línea de entrada (10), el modo "Line-in" se activará automáticamente y visualizarás "aux " en el display.
