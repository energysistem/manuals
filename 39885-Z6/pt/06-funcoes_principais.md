...
Ao ligar automaticamente o dispositivo, é iniciado o modo de entrada de linha. Ligue o cabo de áudio (incluido) na saída de qualquer leitor e à entrada AUDIO-IN (13) do *Energy Music Box Z6* para utilizar o modo de altifalante. Para mudar entre os diferentes modos de leitura, aperte o botão MODO (3).
