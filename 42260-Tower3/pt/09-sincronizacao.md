...
Pressionando o botão modo (5) para seleccionar o modo Bluetooth, irão aparecer no display as letras "bt". 
...
Se você quiser remover a sincronização actual e sincronizar qualquer outro dispositivo, você tem que pressionar o botão (4) por 2 segundos e iniciar uma nova pesquisa, ou você também pode sair do modo Bluetooth e entrar novamente com o botão modo (5).
