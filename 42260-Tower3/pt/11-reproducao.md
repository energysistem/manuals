...
Para reproduzir arquivos MP3, insere uma memória externa USB ou um cartão SD/MMC nas ranhuras correspondentes apropriados, (-) e (-), respectivamente. 
...
Para navegar entre as canções, use o avanço () e retrocesso (). Você também pode alterar a pasta pressionando o botão ().
