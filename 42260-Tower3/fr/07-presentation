...
Lorsque vous connectez un périphérique sur l'une des connexions,  *l’Energy Tower 3* passera automatiquement à cette fonction. Si vous avez raccordé un ou toutes les entrées, la touche X () permet de changer entre tous ceux disponibles. 
