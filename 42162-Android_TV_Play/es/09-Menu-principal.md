...
2. **Desplegable Configuración** Pulsando en el icono izquierdo de configuración, o deslizando el cursor hacia el borde izquierdo de la pantalla, se accede directamente a la configuración de fondo de pantalla, posición de los accesos directos en la pantalla principal y sistema.
