...
Para utiliza esta función, utiliza el cable de audio facilitado junto al producto. Conecta el extremo RCA (L y R) en la entrada (8) estéreo (L y R respectivamente); y en el otro extremo jack 3.5mm la salida del dispositivo de audio que vayas a utilizar, como un reproductor MP3, un ordenador portátil, un smartphone, etc. 
...
Recuerda que en el modo de entrada auxiliar no podrás usar los botones *Avance (2)* y *Retroceso (83)* para cambiar de canción. Deberás hacerlo desde tu dispositivo de audio (reproductor externo) conectado.
