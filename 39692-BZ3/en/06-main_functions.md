...
When you turn the device, pairing mode will start automatically. To change into "line-in" mode, you only need to connect audio cable (included) to the line-in connection (14). Press the MODE button (3) to switch between different playback modes.
...
When the speaker stop emit sound or appear some distostion, is the time to charge it. Connect the mini USB end of the included USB cable to your *Energy Music Box BZ3 Bluetooth* (11) and the other end to any USB port that can provide energy (PC, USB wall charger, car, etc). The LED INDICATOR (10) will turn in red color and when the charge is completed the LED will turn off.
