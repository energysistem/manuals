...
Para cambiar entre las diferentes funciones, pulsa el botón CAMBIO DE FUNCIÓN (3), visualizarás en el display la función selecionada. En caso de no haber nada conectado a las entradas USB y SD/MMC, el botón CAMBIO DE FUNCIÓN (3) conmutará entre el modo APP, Bluetooth y Entrada auxiliar 2 .
